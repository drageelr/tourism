    ...
    const addedPromos = this.state.promos.map((d, index) =>
      <tr style={{ marginLeft: "10px" }}>
        ...
        <td style={{ backgroundColor: "#f5f5f5", padding: "10px", marginLeft: "20px" }}><FontAwesomeIcon onClick={() => {
          api("code/delete", { code: d.code }, 200).then(this.remove(index))
    ...
    return (
      ...
      >
        ...
        <div className="btn-handler">
          <Button className="signup-btn" type="submit" onClick={() => window.location.href = "/create-promo/admin"}>Create Promo</Button>
